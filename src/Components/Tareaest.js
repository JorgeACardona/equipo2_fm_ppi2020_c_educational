...
function Tareaest(){
    return(
        ...
        <div id="cont_tarea"><h3>
            <img id="cuaderno"src={cuaderno} alt="" width="80" height="80"></img>Guía de Estereotipos</h3>
        </div> 

        <div id="conjunto">
            <p id="indi"> Leer con atención la guía y resuelva las actividades propuestas.</p> 
            <h3 id="indi"><img src={word} width="80" height="80"></img> Guía de Estereotipos</h3>
        </div>
        <div id="subir">
            <h2>Tu trabajo</h2>
